	...
	<form action=" " method="post">
		...
		<div class="formcontainer">
			<div class="container">
				...
				<?php if (!empty($error['firstname'])) { ?> <p style="color:red; text-align:center"> <?php echo $error['firstname']; ?> </p> <?php } ?> <br>
				<label for="uname"><strong>Last Name</strong></label>
				<input type="text" placeholder="Enter Username" name="lastname">
				<?php if (!empty($error['lastname'])) { ?> <p style="color:red; text-align:center">
						echo $error['lastname'];
						?> </p> <?php } ?> <br><br>
				<label for="mail"><strong>E-mail</strong></label>
				<input type="text" placeholder="Enter E-mail" name="email">
				<?php if (!empty($error['email'])) { ?> <p style="color:red; text-align:center"> <?php
																									echo $error['email'];
																									?> </p> <?php } ?> <br> 
				<label for="psw"><strong>Password</strong></label>
				<input type="password" placeholder="Enter Password" name="psw">
				<?php if (!empty($error['password'])) { ?> <p style="color:red; text-align:center"> <?php
																									echo $error['password'];
																									?> </p> <?php } ?> <br> 
			</div>
